function NavBar() {
    return (
        <header className="text-orange-700 font-open_sans">
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                <a className="flex title-font font-medium items-center text-orange-900 mb-4 md:mb-0">
                    ...
                    <span className="ml-3 text-xl">Portfolio Aaron Dario Nadelman</span>
                </a>
                <nav className="md:ml-auto flex flex-wrap items-center text-orange-700 justify-center">
                    <a className="mr-5 text-orange-700 hover:text-gray-900">Mis capacitaciones</a>
                    <a className="mr-5 text-orange-700 hover:text-gray-900">Contacto</a>
                    <a className="mr-5 text-orange-700 hover:text-gray-900">Sobre mi</a>
                    <a className="mr-5 text-orange-700 hover:text-gray-900">Recursos para aprender dearrollo web</a>
                </nav>
            </div>
        </header>
    );
